...
export class ContainerDevtools extends BaseDevtools<IContainer> {
	...
	public constructor(props: ContainerDevtoolsProps) {
		console.log('ContainerDevtools constructor', props)
		...
		console.log('ContainerDevtools super', this.containerData)
	...
	protected override getSupportedFeatures(): ContainerDevtoolsFeatureFlags {
		// TODO: Add feature flag for container state management. Should be set to True.
		return {
